...
public abstract class SegmentAdapter extends BaseAdapter implements
		SectionIndexer, OnScrollListener {
	public static final String TAG = SegmentAdapter.class.getSimpleName();
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (view instanceof SegmentListView) {
			((SegmentListView) view).configureHeaderView(firstVisibleItem);
		}
	...
	public final View getView(int position, View convertView, ViewGroup parent) {
		View res = getSectionView(position, convertView, parent);
	 ...
	 * call {@link SegmentListView#tellNoMoreData()} if there is no more pages.
	 * 
	 * @param page
