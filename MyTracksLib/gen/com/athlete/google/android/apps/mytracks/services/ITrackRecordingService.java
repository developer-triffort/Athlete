 ...
 * Original file: D:\\Eclipse Old\\wsTrack\\MyTracksLib\\src\\com\\athlete\\google\\android\\apps\\mytracks\\services\\ITrackRecordingService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.athlete.google.android.apps.mytracks.services.ITrackRecordingService
{
private static final java.lang.String DESCRIPTOR = "com.athlete.google.android.apps.mytracks.services.ITrackRecordingService";
...
/**
 * Cast an IBinder object into an com.athlete.google.android.apps.mytracks.services.ITrackRecordingService interface,
 * generating a proxy if needed.
 */
public static com.athlete.google.android.apps.mytracks.services.ITrackRecordingService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.athlete.google.android.apps.mytracks.services.ITrackRecordingService))) {
return ((com.athlete.google.android.apps.mytracks.services.ITrackRecordingService)iin);
}
return new com.athlete.google.android.apps.mytracks.services.ITrackRecordingService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.athlete.google.android.apps.mytracks.content.WaypointCreationRequest _arg0;
if ((0!=data.readInt())) {
_arg0 = com.athlete.google.android.apps.mytracks.content.WaypointCreationRequest.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
private static class Proxy implements com.athlete.google.android.apps.mytracks.services.ITrackRecordingService
{
...
/**
   ...
   */
@Override public long insertWaypoint(com.athlete.google.android.apps.mytracks.content.WaypointCreationRequest request) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
/**
   ...
   * @return the ID of the inserted waypoint
   */
public long insertWaypoint(com.athlete.google.android.apps.mytracks.content.WaypointCreationRequest request) throws android.os.RemoteException;
/**
   * Inserts a track point in the current recording track.
   *
   * When recording a track, GPS locations are automatically inserted. This is used for
