...
import com.athlete.control.sectionlistview.Data;
import com.athlete.model.User;
import com.segment.SegmentAdapter;

public class SectionComposerAdapter extends SegmentAdapter {
	 ...
	 * @author edBaev
	 */
	public SectionComposerAdapter(Context ctx, List<User> friends) {

		this.ctx = ctx;
		all = Data.getAllData(friends);
	}
