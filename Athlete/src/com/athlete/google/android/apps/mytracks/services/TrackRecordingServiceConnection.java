...
import com.athlete.BuildConfig;
...
public class TrackRecordingServiceConnection {
	...
	private static final String TAG = TrackRecordingServiceConnection.class
			.getSimpleName();
	...
	public ITrackRecordingService getServiceIfBound() {
		if (trackRecordingService != null
				&& !trackRecordingService.asBinder().isBinderAlive()) {
			setTrackRecordingService(null);
			return null;
		}
	...
	private void bindService(boolean startIfNeeded) {
		...
		if (!startIfNeeded
				&& !TrackRecordingServiceConnectionUtils
						.isRecordingServiceRunning(context)) {
