...
import com.athlete.google.android.apps.mytracks.content.TracksColumns;
...
import com.athlete.util.SystemUtils;
...
public class SaveAsyncTask extends AsyncTask<Void, Integer, Boolean> {
	 ...
	 * 
	 * @param saveActivity
	 *            the activity currently associated with this task.
	 * @param trackFileFormat
	 *            the track format
	 * @param trackId
	 *            the track id
	 * @param useTempDir
	 *            true to use the temp directory
	 */
	public SaveAsyncTask(SaveActivity saveActivity,TrackFileFormat trackFileFormat, long trackId, boolean useTempDir) {
	 ...
	 * 
	 * @param saveActivity
	 *            the current activity, can be null
	 */
	 ...
	 * @param id
	 *            the track id
	 * @param updateSavingProgress
	 *            true to update the saving progress
	 */
	private Boolean saveOneTrack(long id, final boolean updateSavingProgress) {
		trackWriter = TrackWriterFactory.newWriter(context,
				myTracksProviderUtils, id, trackFileFormat);
		if (trackWriter == null) {
