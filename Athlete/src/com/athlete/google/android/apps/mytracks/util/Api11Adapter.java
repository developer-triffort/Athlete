...
import com.athlete.google.android.apps.mytracks.ContextualActionModeCallback;
...
public class Api11Adapter extends Api10Adapter {
	...
	/*@Override
	public void configureListViewContextualMenu(final Activity activity,
			ListView listView,
				...
				actionMode = activity
						.startActionMode(new ActionMode.Callback() {
							...
							public boolean onActionItemClicked(ActionMode mode,
									MenuItem item) {
								mode.finish();
								return contextualActionModeCallback.onClick(
										item.getItemId(), position, id);
							}
						});
	...
	public void configureSearchWidget(Activity activity, final MenuItem menuItem) {
		 ...
		 * activity.getSystemService(Context.SEARCH_SERVICE); SearchView
	...
	@Override
	public <T> void addAllToArrayAdapter(ArrayAdapter<T> arrayAdapter,
			List<T> items) {
