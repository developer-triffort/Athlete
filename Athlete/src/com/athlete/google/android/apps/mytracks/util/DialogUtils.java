...
public class DialogUtils {
	 ...
	 *            the message id
	 * @param okListener
	 *            the listener when OK is clicked
	 */
	public static Dialog createConfirmationDialog(Context context,
			int messageId, DialogInterface.OnClickListener okListener) {
		return createConfirmationDialog(context, messageId, null, okListener,
				null);
	}
	 ...
	 *            the listener when cancel is clicked
	 */
	public static Dialog createConfirmationDialog(Context context,
	 ...
	 *            the context
	 * @param messageId
	 *            the progress message id
	 * @param onCancelListener
	 *            the cancel listener
	 */
	public static ProgressDialog createSpinnerProgressDialog(Context context,
			int messageId, DialogInterface.OnCancelListener onCancelListener) {
	 ...
	 *            the cancel listener
	 * @param formatArgs
	 *            the format arguments for the messageId
	 */
	public static ProgressDialog createHorizontalProgressDialog(
			Context context, int messageId,
			DialogInterface.OnCancelListener onCancelListener,
			Object... formatArgs) {
		return createProgressDialog(false, context, messageId,
				onCancelListener, formatArgs);
	}
	 ...
	 *            the cancel listener
	 * @param formatArgs
	 *            the format arguments for the message id
	 */
