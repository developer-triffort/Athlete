...
public class PreferencesUtils {
	 ...
	 */
	//CodeAdded
	public static boolean getMetricUnit(Context context) {

		SharedPreferences sharedPreferences = context.getSharedPreferences(
				com.athlete.Constants.PREFERENCES, Context.MODE_PRIVATE);

		if (sharedPreferences.getString(
				com.athlete.Constants.INTENT_KEY.METRIC,
				context.getResources().getString(R.string.btn_miles)).equals(
				context.getResources().getString(R.string.btn_miles))) {
			return false;
		}
		return true;
	}
	...
	public static boolean getBoolean(Context context, int keyId,
		...
		return sharedPreferences.getBoolean(getKey(context, keyId),
				defaultValue);
	}
	...
	public static String getString(Context context, int keyId,
		...
		return sharedPreferences
				.getString(getKey(context, keyId), defaultValue);
	}
