...
public class MyTracksProvider extends ContentProvider {
	...
	@VisibleForTesting
	static final String DATABASE_NAME = "athlete_mytracks.db";
	...
	static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			if (oldVersion < newVersion) {
				...
				Log.e("Deleting", "Deleting all old data.");
	...
	private boolean canAccess() {
		if (Binder.getCallingPid() == Process.myPid()) {
			...
			return PreferencesUtils.getBoolean(getContext(),
	...
	private Uri insertTrack(Uri url, ContentValues contentValues) {
		boolean hasStartTime = contentValues
				.containsKey(TracksColumns.STARTTIME);
